...
const seeds: ProductSeed[] = [
  ...
  // ── Saklama Kapları ──────────────────────────────────────────────
  // The old skl-esk* / skl-m5 / skl-m8 vacuum-jar built-ins were replaced by
  // the Bonny / Dikdörtgen set products (custom catalog) and have been
  // removed from the seed list; migration 025 purges their DB rows.
  {
    id: "skl-m6",
    imageCount: 5,
  ...
  },
  {
    ...
    description:
      "Büyük Çekmece Modülü, derin ve geniş çekmecesiyle paletler, fırçalar ve daha büyük kozmetik ürünler için yer açar. Düz üst yüzeyi sayesinde diğer organizerlerle üst üste istiflenerek modüler bir düzen kurar.",
    features: [
      "Derin ve geniş tek çekmece",
      "Üst üste istiflenebilir düz yüzey",
      "Tezgâh üstü veya çekmece içi kullanım",
      "Şeffaf füme gövde",
    ],
    materials: "Şeffaf akrilik.",
    care: "Nemli bezle silin. Alkol bazlı temizleyicilerden kaçının.",
    tags: ["organizer", "cekmece", "modul", "makyaj"],
    isNew: true,
  },
  {
    id: "org-kpamukluk",
    imageCount: 1,
    name: "Kulak Çubuğu Pamukluk",
    topCategory: "genel-ev-urunleri",
    category: "organizerlar",
    price: 129.99,
    stock: 24,
    ...
    description:
      "Kulak Çubuğu Pamukluk, kapağıyla içindekileri tozdan korurken eğimli iç tabanı çubukları öndeki alma bölmesine yönlendirir. Banyo tezgâhında ya da makyaj masasında düzenli ve hijyenik bir görünüm sağlar.",
    features: [
      "Toz geçirmeyen kapak",
      "Eğimli taban ile öne akış",
      "Tek elle kolay alma bölmesi",
      "Şeffaf füme gövde",
    ],
    materials: "Şeffaf akrilik.",
    care: "Nemli bezle silin. Alkol bazlı temizleyicilerden kaçının.",
    tags: ["organizer", "pamukluk", "kulak-cubugu", "banyo"],
    isNew: true,
  },
  {
    id: "org-papatya",
    imageCount: 1,
    name: "Papatya Organizer",
    topCategory: "genel-ev-urunleri",
    category: "organizerlar",
    price: 179.99,
    stock: 24,
    ...
    description:
      "Papatya Organizer, çiçek formunda dizilmiş yedi silindir bölmesiyle makyaj fırçalarını, göz kalemlerini ve rimelleri tek tek ayırır. Kompakt tabanı tezgâh üstünde az yer kaplar; her bölme kolayca görülür ve erişilir.",
    features: [
      "Yedi ayrı silindir bölme",
      "Fırça, kalem ve rimel için ideal",
      "Kompakt papatya formu",
      "Şeffaf füme gövde",
    ],
    materials: "Şeffaf akrilik.",
    care: "Nemli bezle silin. Alkol bazlı temizleyicilerden kaçının.",
    tags: ["organizer", "firca", "kalem", "makyaj"],
    isNew: true,
  },
  {
    id: "org-oje3cek",
    imageCount: 1,
    name: "Üç Çekmeceli Oje Düzenleyici",
    topCategory: "genel-ev-urunleri",
    category: "organizerlar",
    price: 449.99,
    stock: 12,
    ...
    description:
      "Üç Çekmeceli Oje Düzenleyici, kademeli üst raflarında ojeleri ve rujları etiketleri görünür şekilde sıralar; alttaki iki küçük ve bir geniş çekmece ise aksesuar ve ürünlerinizi tozdan uzak saklar. Metal kulplu çekmeceler yumuşak açılıp kapanır.",
    features: [
      "Kademeli üst raflar ile görünür yerleşim",
      "İki küçük + bir geniş çekmece",
      "Metal kulplu çekmeceler",
      "Şeffaf füme gövde",
    ],
    materials: "Şeffaf akrilik, metal kulp.",
    care: "Nemli bezle silin. Alkol bazlı temizleyicilerden kaçının.",
    tags: ["organizer", "oje", "cekmece", "makyaj"],
    isNew: true,
  },
];
