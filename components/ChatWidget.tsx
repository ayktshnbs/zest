      ...
      <AnimatePresence>
        {!open ? (
          <motion.button
            ...
            className="fixed right-4 bottom-28 lg:right-6 lg:bottom-6 z-40 flex items-center gap-2 rounded-full bg-foreground text-background pl-4 pr-5 py-3 shadow-xl shadow-black/20 hover:opacity-90 transition-opacity"
          >
      ...
      <AnimatePresence>
        {open ? (
          <motion.div
            ...
            className="fixed right-4 bottom-28 lg:right-6 lg:bottom-6 z-[80] flex flex-col w-[calc(100vw-2rem)] sm:w-[380px] h-[calc(100dvh-14rem)] max-h-[560px] bg-background border border-foreground/10 rounded-2xl shadow-2xl shadow-black/30 overflow-hidden"
          >
            {/* Header */}
