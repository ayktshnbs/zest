...
export default function Home() {
  const categories = [
    { name: "Professional Knives", img: "https://images.unsplash.com/photo-1593618998160-e34014e67546?auto=format&fit=crop&q=80&w=800", color: "bg-primary/5" },
    { name: "Non-Stick Pans", img: "https://images.unsplash.com/photo-1584947848229-45a44c00abf1?auto=format&fit=crop&q=80&w=800", color: "bg-secondary/5" },
    { name: "Ceramic Plates", img: "https://images.unsplash.com/photo-1591192801546-7037583ee3e8?auto=format&fit=crop&q=80&w=800", color: "bg-stone-dark/5" },
  ];
    ...
    <main className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-16 grid lg:grid-cols-2 gap-12 items-center">
          <div className="z-10 py-12 lg:py-0">
            <h1 className="font-display text-5xl md:text-7xl font-extrabold text-[#1c1c13] leading-[1.1] mb-6">
              Precision <span className="text-[#b80035] italic">Tools</span> <br />
              for the Modern Kitchen.
            </h1>
            <p className="font-body text-lg md:text-xl text-[#5c3f40] max-w-lg mb-10 leading-relaxed">
              Curated, high-performance kitchenware designed for durability and style. Explore our collection of non-toxic, professional-grade essentials that elevate your home.
            </p>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-5 md:px-16">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl font-bold text-[#1c1c13]">Shop by Category</h2>
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-16">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-xl">
              <span className="text-[#b80035] font-bold tracking-widest text-sm uppercase mb-3 block">Top Sellers</span>
              <h2 className="font-display text-4xl md:text-5xl font-bold text-[#1c1c13]">Essentials for the Modern Home Cook</h2>
            </div>
      ...
      <section className="py-24 bg-[#b80035] text-white">
        <div className="max-w-4xl mx-auto px-5 text-center">
          <h2 className="font-display text-4xl font-bold mb-6">Get Insider Access</h2>
          <p className="text-white/80 font-body text-lg mb-10 max-w-xl mx-auto">
            Be the first to know about new product drops, limited edition colors, and exclusive seasonal sales.
          </p>
